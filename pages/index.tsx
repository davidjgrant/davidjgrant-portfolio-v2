    ...
    <Layout>
      <GradientBanner gradient={'amber-pink-gradient'}>
        <motion.h1
          ...
          className="my-2 sm:my-4 text-3xl sm:text-5xl font-bold capitalize p-3 text-white"
        >
        ...
        <motion.div
          variants={fade}
          className="dark:bg-black bg-gray-50 p-4 rounded-full absolute -bottom-20 left-1/2 transform -translate-x-1/2 max-w-[200px] md:max-w-none w-40 h-40 sm:w-60 sm:h-60"
        >
          <Image
