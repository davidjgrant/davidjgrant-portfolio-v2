  ...
  return (
    <Layout>
        <GradientBanner gradient={'amber-pink-gradient'}>
          <motion.h1 variants={titleAnimation} initial='hidden' whileInView='show' viewport={{ once: true, amount: 0.8 }} className='text-2xl sm:text-3xl font-semibold p-3 text-white'>DavidJGrant Portfolio</motion.h1>
