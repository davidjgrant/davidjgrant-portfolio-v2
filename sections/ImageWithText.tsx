...
const ImageWithText = ({ featuredBanner: { featuredTitle, featuredDescription }}) => {
  return (
    <motion.div variants={fade} initial='hidden' whileInView='show' viewport={{ once: true }} className='min-w-full bg-gray-100 dark:bg-zinc-900 h-fit lg:-mx-[20vw] my-16 md:my-32'>
      <div className='container flex flex-col md:flex-row items-center justify-between'>
        <div className='text-left max-w-3xl px-8 md:px-4 py-8 mr-auto'>
